...
TAG=9.4,9.4.0 VERSION=9.4 FROM=solr:9.4.0-slim build
TAG=9.4-extras,9.4.0-extras VERSION=9.4-extras FROM=solr:9.4.0-slim INCLUDE_EXTRAS=1 build
TAG=9,9.5,9.5.0 VERSION=9.5 FROM=solr:9.5.0-slim build
TAG=9-extras,9.5-extras,9.5.0-extras VERSION=9.5-extras FROM=solr:9.5.0-slim INCLUDE_EXTRAS=1 build
